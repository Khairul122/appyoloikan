  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<MLPackage>(
            icon: const Icon(Icons.settings, color: AppColors.surface),
            onSelected: (MLPackage package) {
              controller.switchMLPackage(package);
            },
            itemBuilder: (BuildContext context) => [
              const PopupMenuItem(
                value: MLPackage.flutterVision,
                child: Text('Flutter Vision'),
              ),
              const PopupMenuItem(
                value: MLPackage.ultralytics,
                child: Text('Ultralytics YOLO'),
              ),
            ],
          ),
        ],
